...
NestJS + TypeScript strict, PostgreSQL + Prisma ([ADR 0013](docs/adr/0013-migration-postgresql-prisma.md)).
Voir `docs/adr/` pour les décisions d'architecture qui encadrent ce dépôt
(stack, auth, paiements, documents sensibles, tests, conventions Git...).
...
| `npm run test:e2e` | Tests end-to-end (Jest + Postgres éphémère via Docker, voir `docs/testing.md`) |
