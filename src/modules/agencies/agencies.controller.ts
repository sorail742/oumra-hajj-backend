...
export class AgenciesController {
  ...
  @Public()
  @Post('register')
  register(@Body() dto: RegisterAgencyDto): Promise<AgencyDocument> {
  ...
  @Roles(Role.AGENCY)
  @Get('me')
  getOwn(@CurrentUser() user: JwtPayload): Promise<AgencyDocument> {
  ...
  @Roles(Role.ADMIN)
  @Get(':id')
  getById(@Param('id') id: string): Promise<AgencyDocument> {
